...
echo .SKU name : GPV01KB (Korea) or H.APV03KB (US/...)
...
:: 1. System Information (Type 1) structure
...
rem NB2MFG1.exe /s MT "14Z90T-GPV01KB"
...
) else if %MODEL:~0,3%==15Z (
	NB2MFG1.exe /S FD "gram"
) else if %MODEL:~0,3%==15U (
	NB2MFG1.exe /S FD "UltraPC"
) else (
	echo .No model name input
)
